...
<%@include file="../contract/contract_signature_client.jsp" %>
...
<input type="hidden" id="modal_url" value="/contract/list"/>
<input type="hidden" id="modeltype" value="contract" />
<input type="hidden" id="skhcq_api_url" value="<%=request.getContextPath()%>" />
<input type="hidden" id="IsSignature" value="<c:out value="${data.signature}"/>" />
<input type="hidden" id="btntype" value="${data.btnType}" />
<input type="hidden" id="datatype" value="<c:out value="${data.dataType}"/>" />
<input type="hidden" id="dataid" value="<c:out value="${data.dataId}"/>" />
<input type="hidden" id="indexname" value="<c:out value="${data.indexName}"/>" />
<input type="hidden" id="currentUserCname" value="<c:out value="${data.currentUserCname}"/>" />
<input type="hidden" id="idenId" value="<c:out value="${data.idenId}"/>" />
<input type="hidden" id="modal" value="<c:out value="${data.module}"/>" />
<input type="hidden" id="contractorAgentUserId" value="<c:out value="${data.contractorAgentUserId}"/>" />
<input type="hidden" id="currentUserid" value="<c:out value="${data.currentUserid}"/>" />
<input type="hidden" id="dispord" value="<c:out value="${data.dispord}"/>" />
<input type="hidden" id="taskName" value="<c:out value="${data.taskName}"/>" />
