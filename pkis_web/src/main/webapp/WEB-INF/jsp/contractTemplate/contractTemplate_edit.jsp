...
<input type="hidden" id="modal_url" value="/contractTemplate/manage"/>
...
<input type="hidden" id="docver" value="<c:out value="${data.docver}"/>" />
<input type="hidden" id="isConTemplate" value="Y"/>
