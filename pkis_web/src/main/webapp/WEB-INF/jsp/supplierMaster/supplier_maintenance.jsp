...
$(function() {
	$("#btnInsert").on("click", function() {
		...
		if ($("#dataForm").valid()) {
			ajax.setController("<c:url value="/supplier/maintenance/insertData" />");
			...
			ajax.call(function(result) {
				...
				if(result){
					$.fn.alert(result.messages, function(){
						if(result.status == "ok"){
							location.href='<c:url value='/supplier/maintenance/' />';
						}
					});
				}
			});
	...
	$("#btnUpdate").on("click", function() {
		...
		if ($("#dataForm").valid()) {
			ajax.setController("<c:url value="/supplier/maintenance/updateData" />");
			ajax.put("paramsData", $("#dataForm").serializeObject());
			ajax.call(function(result) {
				console.log("result == ", result);
				if(result){
...
<!-- 						</div> -->
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group row">
								<label  class="col-sm-2 col-form-label"><spring:message code="suppliter.field.suppliercname" /></label>
								<div class="col-sm-9">
									<input type="text"  id="suppliercname"  name="suppliercname" readonly class="form-control" value="<c:out value="${data.suppliercname}"/>" >
								</div>
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group row">
								...
								<div class="col-sm-9">
									<input type="text" id="supplierename" readonly  name="supplierename" class="form-control" value="<c:out value="${data.supplierename}"/>">
								</div>
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-md-12">
							<div class="form-group row">
								...
								<div class="col-sm-10">
									<input type="text" id="suppliercaddr" readonly  name="suppliercaddr" class="form-control" value="<c:out value="${data.suppliercaddr}"/>">
								</div>
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-md-12">
							<div class="form-group row">
								...
								<div class="col-sm-10">
									<input type="text" id="suppliereaddr" readonly  name="suppliereaddr" class="form-control" value="<c:out value="${data.suppliereaddr}"/>">
								</div>
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-md-6">
							<div class="form-group row">
								<label data-require=true class="col-sm-2 col-form-label"><spring:message code="suppliter.field.picuser" /></label>
								<div class="col-sm-9">
									<input type="text" id="picuser" name="picuser" class="form-control" value="<c:out value="${data.picuser}"/>"required>
								</div>
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group row">
								...
								<div class="col-sm-9">
									<input type="text" id="supplieretel" readonly  name="supplieretel" class="form-control" value="<c:out value="${data.supplieretel}"/>">
								</div>
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-md-6">
							<div class="form-group row">
								<label data-require=true class="col-sm-2 col-form-label"><spring:message code="suppliter.field.contacruser" /></label>
								<div class="col-sm-9">
									<input  type="text" id="contacruser" name="contacruser" class="form-control" value="<c:out value="${data.contacruser}"/>" required>
								</div>
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group row">
								<label data-require=true class="col-sm-2 col-form-label"><spring:message code="suppliter.field.supplieremail" /></label>
								<div class="col-sm-9">
									<input type="text" id="supplieremail" name="supplieremail" class="form-control" value="<c:out value="${data.supplieremail}"/> "required>
								</div>
							</div>
						</div>
					</div>
