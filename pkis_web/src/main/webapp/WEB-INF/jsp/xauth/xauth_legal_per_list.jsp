...
<script type="text/javascript">
	...
	$(function () {
		...
		grid.setController("<c:url value='/xauth/legalPer/query' />");
	...
	function toDelete(rid) {
		$.fn.confirm('<spring:message code="common.confirm.delete"/>', function() {
			var ajax = new $.tvAjax();
			ajax.setController("<c:url value="/xauth/legalPer/delete"/>");
	...
	<div class="col-12 grid-margin stretch-card">
		<div class="card">
			<div class="card-body">
				...
				<form id="dataForm" name="dataForm" class="forms-sample" action="<c:url value="/xauth/legalPer/data"/>" method="POST">
